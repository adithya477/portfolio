...
var Swiper = (function() {
    ...
    const z = (e, t) => {
        ...
        $ = (e) => {
            ...
            if (e.params.rewind || e.params.loop)
                ...
                for (
                    let a = Math.max(i - t, 0); a <= Math.min(r + t, s - 1); a += 1
                )
                    a !== i && (a > r || a < i) && A(e, a);
        };
    var I = {
        ...
        updateSlides: function() {
            ...
            for (let i = 0; i < m; i += 1) {
                ...
                if (
                    ((z = 0),
                        u[i] && (r = u[i]),
                        L && e.grid.updateSlide(i, r, m, t), !u[i] || "none" !== v(r, "display"))
                ) {
            ...
            if (
                ...
                (f = t),
                Math.floor(e.virtualSize - n) - Math.floor(f[f.length - 1]) >
            ...
            if (d && a.loop) {
                ...
                for (
                    let s = 0; s < e.virtual.slidesBefore + e.virtual.slidesAfter; s += 1
                )
            ...
            if (
                (m !== c && e.emit("slidesLengthChange"),
                    ...
                    a.watchSlidesProgress && e.updateSlidesOffset(), !(d || a.cssMode || ("slide" !== a.effect && "fade" !== a.effect)))
            ) {
    ...
    function X(e) {
        ...
        if (
            (r.touchReleaseOnEdges && (S = 0),
                ...
                x && (c.preventedByNestedSwiper = !0), !s.allowSlideNext &&
    ...
    function Y(e) {
        ...
        if (
            (a >= 0 && s.evCache.splice(a, 1), ["pointercancel", "pointerout", "pointerleave"].includes(e.type))
        ) {
            if (!(
        ...
        for (
            let e = 0; e < d.length; e += e < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup
        ) {
        ...
        init(e) {
            ...
            return (!1 === t.mount(e) ||
                (t.emit("beforeInit"),
                    ...
                    t.attachEvents(), [...t.el.querySelectorAll('[loading="lazy"]')].forEach((e) => {
                        e.complete ?
                            z(t, e) :
            ...
            function d(e) {
                ...
                if (!(
                    ...
                    if (
                        ...
                        let e = !1;
                        if (
                            b(t.el, `.${t.params.slideClass}, swiper-slide`).length >
                            0 &&
                ...
                a("click", (e, s) => {
                    ...
                    if (
                        ...
                        a.length ?
                            ...
                            i(!0 === e ? "navigationShow" : "navigationHide"), [...a, ...n]
                            .filter((e) => !!e)
                            .forEach((e) =>
        ...
        function(e) {
            ...
            function $() {
                ...
                t.wrapperEl.addEventListener("pointerdown", x, s),
                    t.wrapperEl.addEventListener("pointermove", S, a), ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
            ...
            function I() {
                ...
                t.wrapperEl.removeEventListener("pointerdown", x, s),
                    t.wrapperEl.removeEventListener("pointermove", S, a), ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
                            ...
                            g() &&
                                t.pagination.bullets.forEach((s) => {
                                    t.params.pagination.clickable &&
                                        ...
                                        s.matches(
                                            ee(t.params.pagination.bulletActiveClass)
                                        ) ?
                ...
                updateSlide: (e, r, l, o) => {
                    ...
                    if ("row" === u && d > 1) {
                        const s = Math.floor(e / (d * p)),
                            ...
                            0 === s ?
                            d :
                            Math.min(Math.ceil((l - s * p * d) / p), d);
                        (f = Math.floor(a / i)),
                        (h = a - f * i + s * d),
                        (m = h + (f * t) / p),
                        (r.style.order = m);
                        ...
                        for (let e = 0, t = a.length; e < t; e += 1) {
                            ...
                            if (
                                ...
                                e || (e = de("coverflow", t, n ? "left" : "top")),
                                    s ||
                                    (s = de("coverflow", t, n ? "right" : "bottom")),
